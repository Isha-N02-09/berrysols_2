...
export default function FAQPage() {
  ...
  return (
    <main className="faq-shell min-h-screen bg-[#f8f5f1] text-[#171410]">
      <Navbar />

      <section className="faq-container pt-28 pb-12 md:pt-36 lg:pt-40">
        <div className="max-w-5xl">
          <p className="mb-4 text-[11px] font-semibold uppercase tracking-[0.26em] text-[#f45e2b]">
            Berry Solutions / FAQs
          </p>
          <h1 className="text-[4rem] font-black leading-[0.9] tracking-[-0.06em] text-black md:text-[7rem] lg:text-[9rem]">
            FAQs
          </h1>
          <p className="mt-7 max-w-2xl text-lg leading-8 text-[#5f5b55] md:text-xl">
            Frequently asked questions. Here are some common questions about our IT services, web development, SEO, cloud support, and digital growth strategy.
          </p>
        </div>
      </section>
