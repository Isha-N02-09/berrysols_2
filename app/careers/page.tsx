...
export default function CareersPage() {
  return (
    <main id="top" className="min-h-screen bg-[#fffdf8] text-[#171410]">
      ...
      <section className="relative overflow-hidden px-[var(--gutter)] pb-24 pt-36 md:pb-32 md:pt-48">
        <div className="absolute -right-24 top-24 h-72 w-72 rounded-full border border-[#f45e2b]/20 bg-[#ff9c6b]/10 md:h-[28rem] md:w-[28rem]" aria-hidden="true" />
        <div className="absolute right-20 top-48 h-28 w-28 rounded-full bg-[#f45e2b] shadow-[0_20px_60px_rgba(244,94,43,.22)] md:right-48 md:h-40 md:w-40" aria-hidden="true" />
        <div className="relative mx-auto max-w-[1200px]">
          <div className="max-w-4xl">
            <p className="mb-7 flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.2em] text-[#ce4111]">
              <span className="h-px w-8 bg-[#f45e2b]" />
              Careers at Berry
            </p>
            <h1 className="max-w-5xl text-6xl font-extrabold uppercase leading-[0.9] tracking-[-0.06em] sm:text-7xl lg:text-[8.2rem]">
              Make work that <span className="hero-clarity text-[#f45e2b]">moves</span> people.
            </h1>
            <p className="hero-copy mt-10 max-w-xl text-lg leading-8 text-[#756f65] md:text-xl">
              We are a small, ambitious team building digital experiences that turn complicated ideas into clear, useful moments.
            </p>
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <a href="#open-roles" className="inline-flex items-center gap-3 rounded-full bg-[#f45e2b] px-6 py-4 text-sm font-semibold text-white transition-transform hover:-translate-y-1 hover:bg-[#ce4111]">
                See open roles
                <ChevronDown size={17} aria-hidden="true" />
              </a>
              <span className="flex items-center gap-2 text-sm text-[#756f65]">
                <Sparkles size={16} className="text-[#f45e2b]" aria-hidden="true" />
      ...
      <section className="border-y border-black/10 bg-[#f5f0e6] px-[var(--gutter)] py-20 md:py-28">
      ...
      <section id="open-roles" className="px-[var(--gutter)] py-20 md:py-32">
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="flex min-h-56 flex-col items-start justify-center border-y-2 border-[#171410] bg-[#f5f0e6] px-7 py-10 md:px-12">
      ...
      <section className="border-t border-black/10 px-[var(--gutter)] py-20 md:py-28">
        <div className="mx-auto flex max-w-[1200px] flex-col items-start justify-between gap-8 md:flex-row md:items-end">
          ...
          <Link href="/#contact" className="inline-flex items-center gap-2 border-b border-[#171410] pb-2 text-sm font-semibold uppercase tracking-[0.1em] transition-colors hover:border-[#f45e2b] hover:text-[#ce4111]">Talk to Berry <ArrowUpRight size={16} aria-hidden="true" /></Link>
        </div>
      </section>
